...
class DDM(Model):
    ...
    def __init__(self, data=None, input_data_id="PPT", input_data_congruency="Condition", input_data_rt="RT", input_data_accuracy="Correct"):
        ...
        """
        self.modelsimulationfunction = DDM.model_simulation
    ...
    def model_simulation (alpha, beta, delta_c, delta_i, tau, dt=DT, var=VAR, nTrials=NTRIALS, noiseseed=NOISESEED):
        """
