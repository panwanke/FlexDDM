...
"""
Class to simulate data according to the Dual Stage Two Phase model (DSTPfz) 
"""
...
class DSTPfz(Model):
    ...
    def model_simulation(
        ...
        for n in np.arange(0, nTrials):
            ...
            evidenceSS = (
                betaSS * alphaSS / 2 - (1 - betaSS) * alphaSS / 2
            ...
            np.random.seed(n)
            while (evidenceSS < alphaSS / 2 and evidenceSS > -alphaSS / 2) or (
                evidenceRS1 < alphaRS / 2 and evidenceRS1 > -alphaRS / 2
            ...
            # If Stimulus Selection (SS) completes before Response Selection 1 (RS1), begin Response Selection 2 (RS2) from where RS1 left off
                ...
                while (
                    evidenceRS2 < alphaRS / 2 and evidenceRS2 > -alphaRS / 2
                ):  # keep accumulating evidence until you reach a threshold
